python3 UniversalFakeDetect/train.py --name=TUNED3_clip_rn50_bal_weighted_loss_LWMS \
    ...
    --acq_func=9 --balance_acquisition --use_weighted_loss --al_earlystop_metric=ap < /dev/null > train_bal_weighted_loss_LWMS_Tuned.txt 2>&1 &
python3 UniversalFakeDetect/train.py --name=clip_rn50_bal_weighted_loss_LWMS_Tuned \
    ...
    --use_active_learning --niter=15 --al_iter=100 --dropout_iter=10 --query=2500 --acq_func=9 --balance_acquisition --use_weighted_loss < /dev/null > train_bal_weighted_loss_LWMS_Tuned.txt 2>&1 &
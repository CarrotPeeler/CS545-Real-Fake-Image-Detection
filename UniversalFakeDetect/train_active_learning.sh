python3 UniversalFakeDetect/train.py --name=TUNED6_clip_rn50_bal_weighted_loss_LWMS \
    ...
    --acq_func=9 --balance_acquisition --use_weighted_loss --weighted_loss_decay=0.94 --al_earlystop_metric=ap \
    --weight_decay=0.0 --lr=0.0001 < /dev/null > train_bal_weighted_loss_LWMS_Tuned.txt 2>&1 &
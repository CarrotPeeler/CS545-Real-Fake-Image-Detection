...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--loss_freq", type=int, default=400, help="frequency of showing loss on tensorboard"
        )
        parser.add_argument(
            "--val_freq", type=int, default=1, help="frequency (epochs) of showing val"
        )
        parser.add_argument(
            "--save_epoch_freq",
            type=int,
        ...
        parser.add_argument(
            ...
            type=int,
            default=None,
            help="only train this number of images for both fake/real",
        )
        parser.add_argument(
            "--uniform_sample",
            type=bool,
            default=True,
            help="Uniformly sample all dataset sources to create train or val set",
        )
        parser.add_argument(
            "--ckpt",
            type=str,
            default=None,
            help="./UniversalFakeDetect/pretrained_weights/fc_weights.pth",
        )
